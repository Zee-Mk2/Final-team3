          ...
          <div class="col-lg-9">
            <div class="row mt-5">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="titileinput">
              </div>
              <div class="mb-3">
                <label for="contentsinput" class="form-label">내용</label>
                <textarea class="form-control" id="contentsinput" rows="15"></textarea>
              </div>
              <div class="mb-3">
              ...
              <div class="mt-5" style="text-align: center;">
                <a href="#">
                  <button type="button" class="btn text-white" style="background-color: #E8AE50;">글 작성하기</button>
                </a>
              </div>
