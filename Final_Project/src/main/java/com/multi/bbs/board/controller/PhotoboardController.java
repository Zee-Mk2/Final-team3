...
public class PhotoboardController {
	...
	public String list(Model model, @RequestParam Map<String, String> paramMap) {
		...
		return "templates.board/photoBoardlist";
	}
...
//	@RequestMapping("/templates.board/board-detail")
	...
	public String view(Model model, @RequestParam("no") int no) {
		...
		return "tempaltes.board/board-detail";
	}
	...
	public String writeBoard(Model model, HttpSession session,
		...
		if(result > 0) {
			...
			model.addAttribute("location", "/templates.board/photoBoard-list");
		}
	...
	public String writeReply(Model model, 
		...
		model.addAttribute("location", "/templates.board/board-detail?no="+reply.getbNo());
		return "common/msg";
	}
