...
public class CultureBoardController {
	...
	public String list(Model model, @RequestParam Map<String, String> paramMap) {
		...
		return "templates.board/cultureBoard-list";
	}
...
//	@RequestMapping("/board/view")
	...
	@GetMapping("/board-rite")
	public String writeView() {
		return "templates.board/board-write";
	}
	...
	public String writeReply(Model model, 
		...
		int result = service.saveReply(comment);
		m(result > 0) {
